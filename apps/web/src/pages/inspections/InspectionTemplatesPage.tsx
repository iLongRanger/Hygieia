...
interface AutoGeneratedInspectionTemplate extends InspectionTemplate {
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-surface-900 dark:text-surface-100">
                        {template.name}
                        {Boolean((template as AutoGeneratedInspectionTemplate).contractId) && (
                      ...
                      <p className="text-xs text-surface-500 dark:text-surface-400">
                        ...
                        {(template as AutoGeneratedInspectionTemplate).contract?.contractNumber && (
                          <span> &middot; Contract {(template as AutoGeneratedInspectionTemplate).contract?.contractNumber}</span>
                        )}
                      </p>
                    </div>
                  </div>
