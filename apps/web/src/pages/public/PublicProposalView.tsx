    ...
    <div className="mt-3 rounded-xl border border-surface-200 bg-surface-50 p-3">
      ...
      <ul className="mt-2 space-y-1 ml-1">
        {activeGroup.tasks.map((task, index) => (
          <li key={`${serviceId}-${activeGroup.key}-${index}`} className="flex items-start gap-2 text-sm text-surface-600">
            <span
    ...
    return (
      <div className="min-h-screen bg-surface-50 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-surface-800 mb-2">Proposal Not Available</h1>
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor }}>
        ...
        <div className="max-w-4xl mx-auto px-4 py-6 sm:px-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-surface-600 dark:text-surface-400 text-sm mt-1">Proposal {proposal.proposalNumber}</p>
            </div>
            <button
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:px-6">
        ...
        {proposal.description && (
          <div className="mb-8">
            ...
            <p className="text-surface-600 whitespace-pre-wrap">{proposal.description}</p>
          </div>
        )}
        ...
        {proposal.facility && (
          <div className="mb-8 bg-surface-50 rounded-lg border border-surface-200 p-5">
            <h3 className="text-lg font-semibold text-surface-900 mb-3">Facility</h3>
            <div className="flex items-start gap-3">
              <Building2 className="h-5 w-5 text-surface-500 dark:text-surface-400 mt-0.5 shrink-0" />
              <div>
                <div className="font-medium text-surface-900">{proposal.facility.name}</div>
        ...
        {proposal.pricingSnapshot?.operationalEstimate && (
          <div className="mb-8 bg-blue-50 rounded-lg border border-blue-200 p-5">
            <h3 className="text-lg font-semibold text-surface-900 mb-3">Estimated Time On Site</h3>
        ...
        {proposal.proposalServices.length > 0 && (
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-surface-900 mb-3">Services & Areas</h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        <h4 className="font-semibold text-surface-900 text-base">{service.serviceName}</h4>
                        {areaInfo && (
                          <p className="text-sm text-surface-500 mt-0.5">{areaInfo}</p>
                        )}
                      </div>
        ...
        {visibleProposalItems.length > 0 && (
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-surface-900 mb-3">Line Items</h3>
            <div className="bg-surface-50 rounded-lg border border-surface-200 overflow-x-auto">
              <table className="w-full">
          ...
          <div className="bg-surface-50 rounded-lg border border-surface-200 overflow-hidden">
            <div className="p-5">
              <div className="flex justify-between text-sm mb-2">
                <span className="text-surface-500">Monthly Subtotal</span>
                <span className="text-surface-900 font-medium">{formatCurrency(Number(proposal.subtotal) || 0)}</span>
              </div>
              {(Number(proposal.taxRate) || 0) > 0 && (
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-surface-500">Tax ({((Number(proposal.taxRate) || 0) * 100).toFixed(1)}%)</span>
                  <span className="text-surface-900 font-medium">{formatCurrency(Number(proposal.taxAmount) || 0)}</span>
                </div>
              )}
              <div className="flex justify-between items-center pt-3 mt-2 border-t-2 border-surface-200">
                <span className="text-xl font-bold text-surface-900">Monthly Total</span>
        ...
        {/* Terms & Conditions */}
        <div className="mb-8 bg-surface-50 rounded-lg border border-surface-200 p-5">
          <h3 className="text-lg font-semibold text-surface-900 mb-3">Terms</h3>
        ...
        {canAct && !actionComplete && (
          <div className="flex flex-col sm:flex-row gap-3 justify-center py-8 border-t border-surface-200">
            <button
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-8 py-3 bg-surface-50 hover:bg-surface-50 text-red-600 border border-red-200 rounded-lg font-medium transition-colors"
            >
      ...
      {acceptModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="bg-surface-50 rounded-xl shadow-xl max-w-md w-full p-6">
            <h3 className="text-lg font-bold text-surface-900 mb-4">Accept Proposal</h3>
      ...
      {rejectModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="bg-surface-50 rounded-xl shadow-xl max-w-md w-full p-6">
            <h3 className="text-lg font-bold text-surface-900 mb-4">Decline Proposal</h3>
            <div className="mb-4">
              <label className="block text-sm font-medium text-surface-700 mb-1">
