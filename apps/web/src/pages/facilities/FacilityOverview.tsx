    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <div className="rounded-lg border border-surface-200 dark:border-surface-700 bg-surface-100 dark:bg-surface-800/30 p-4">
          ...
          <div className="font-medium text-surface-900 dark:text-white">{activeAreasCount}</div>
        </div>

        <div className="rounded-lg border border-surface-200 dark:border-surface-700 bg-surface-100 dark:bg-surface-800/30 p-4">
          <div className="text-sm text-surface-500 dark:text-surface-400">Total Tasks</div>
          <div className="font-medium text-surface-900 dark:text-white">{activeTasksCount}</div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="whitespace-pre-line font-medium text-surface-900 dark:text-white">
      ...
      <Card>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <div className="text-sm text-surface-900 dark:text-white">{facility.account.name || 'Not specified'}</div>
          ...
          <div>
            ...
            <div className="text-sm text-surface-900 dark:text-white">{facility.facilityManager?.fullName || 'Not assigned'}</div>
          ...
          <div>
            ...
            <div className="text-sm text-surface-900 dark:text-white">{facility.createdByUser?.fullName || 'Unknown'}</div>
          </div>
          <div>
            <div className="text-xs text-surface-500 uppercase tracking-wide">Created At</div>
            <div className="text-sm text-surface-900 dark:text-white">{formatDateTime(facility.createdAt)}</div>
          </div>
          <div>
            <div className="text-xs text-surface-500 uppercase tracking-wide">Last Updated</div>
            <div className="text-sm text-surface-900 dark:text-white">{formatDateTime(facility.updatedAt)}</div>
          </div>
          <div>
            <div className="text-xs text-surface-500 uppercase tracking-wide">Archived At</div>
            <div className="text-sm text-surface-900 dark:text-white">{formatDateTime(facility.archivedAt)}</div>
          </div>
          <div>
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            <div className="text-sm text-surface-900 dark:text-white">{frequency}</div>
          </div>
          <div>
            <div className="text-xs text-surface-500 uppercase tracking-wide">Service Window</div>
            <div className="text-sm text-surface-900 dark:text-white">{allowedWindowStart} - {allowedWindowEnd}</div>
          </div>
          <div className="sm:col-span-2">
            <div className="text-xs text-surface-500 uppercase tracking-wide">Days</div>
            <div className="text-sm text-surface-900 dark:text-white">{scheduleDays || 'Not specified'}</div>
          </div>
        </div>
      </Card>
          ...
          <div className="space-y-4">
            ...
            {facility.notes && (
              <div className="border-t border-surface-200 dark:border-surface-700 pt-4">
                ...
                <div className="text-sm text-surface-900 dark:text-white">{facility.notes}</div>
              </div>
            )}
          </div>
        </Card>
