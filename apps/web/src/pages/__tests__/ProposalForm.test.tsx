...
describe('ProposalForm', () => {
    ...
    listAreasMock.mockResolvedValue({
      data: [
        ...
        },
        {
          ...
          archivedAt: null,
          facility: { id: 'facility-1', name: 'Main Facility', accountId: 'account-1' },
          areaType: { id: 'area-type-2', name: 'Bathroom', defaultSquareFeet: '80', baseCleaningTimeMinutes: null },
          createdByUser: { id: 'user-1', fullName: 'Admin User' },
          fixtures: [],
    ...
    listFacilityTasksMock.mockResolvedValue({
      data: [
        ...
        },
        {
          ...
          archivedAt: null,
          facility: { id: 'facility-1', name: 'Main Facility', accountId: 'account-1' },
          area: { id: 'area-2', name: 'Main Bathroom', areaType: { id: 'area-type-2', name: 'Bathroom' } },
          taskTemplate: null,
          createdByUser: { id: 'user-1', fullName: 'Admin User' },
          fixtureMinutes: [],
        },
  ...
  it('shows specialized catalog jobs and populates the selected job as a line item', async () => {
    ...
    expect(screen.getByLabelText(/proposal title/i)).toHaveValue('Window Cleaning - Main Facility');
    ...
    await waitFor(() => {
      expect(previewResidentialQuoteMock).toHaveBeenCalledWith(
        expect.objectContaining({
          ...
          frequency: '3x_week',
          homeProfile: expect.objectContaining({
            fullBathrooms: 1,
            halfBathrooms: 0,
          }),
        ...
        expect.objectContaining({
          ...
          proposalServices: expect.arrayContaining([
            expect.objectContaining({
              ...
              monthlyPrice: 2080,
              pricingMeta: expect.objectContaining({
                visitPrice: 160,
                visitsPerMonth: 13,
                monthlyBill: 2080,
              }),
