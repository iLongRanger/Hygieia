...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-surface-100 via-surface-50 to-primary-50 p-4 dark:from-surface-900 dark:via-surface-900 dark:to-surface-800">
      ...
      <button
        onClick={toggleTheme}
        className="absolute right-4 top-4 rounded-lg p-2 text-surface-500 transition-colors hover:bg-surface-100 hover:text-surface-700 dark:text-surface-400 dark:hover:bg-surface-800 dark:hover:text-surface-200"
