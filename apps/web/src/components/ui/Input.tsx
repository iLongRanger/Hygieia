      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            id={inputId}
            className={cn(
              'flex h-10 w-full rounded-lg border border-surface-300 bg-surface-50 px-3 py-2 text-surface-900 placeholder:text-surface-400 transition-all duration-200',
