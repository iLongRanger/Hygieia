    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ...
          id={textareaId}
          className={cn(
            'flex min-h-[100px] w-full rounded-lg border border-surface-300 bg-surface-50 px-3 py-2 text-surface-900 placeholder:text-surface-400 transition-all duration-200 resize-none',
