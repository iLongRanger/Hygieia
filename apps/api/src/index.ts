...
import publicResidentialQuotesRoutes from './routes/publicResidentialQuotes';
...
app.use('/api/v1/residential', residentialRoutes);
...
app.use('/api/v1/public/residential-quotes', publicResidentialQuotesRoutes);
