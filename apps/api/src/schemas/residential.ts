...
export const residentialHomeProfileSchema = z.object({
  homeType: residentialHomeTypeSchema.optional().nullable(),
  ...
  occupiedStatus: residentialOccupiedStatusSchema.optional().nullable(),
  condition: residentialConditionSchema.optional().nullable(),
