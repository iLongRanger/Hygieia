...
export function buildResidentialQuoteEmailHtmlWithBranding(
  data: ResidentialQuoteEmailData,
        ...
        <table cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 20px 0; text-align: center;">
              <a href="${data.publicViewUrl}" style="background-color: ${branding.themeAccentColor}; color: ${branding.themePrimaryColor}; padding: 14px 32px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px; display: inline-block;">
                Review Residential Quote
              </a>
            </td>
          </tr>
          <tr>
