        ...
        <table cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 30px;">
              <h2 style="color: ${branding.themePrimaryColor}; margin: 0 0 10px 0; font-size: 20px;">Quotation: ${data.title}</h2>
              <p style="color: #666; margin: 0 0 20px 0; font-size: 14px;">${data.quotationNumber}</p>
